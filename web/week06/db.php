<?php
   ...
   class DB 
   {
      ...
      function createGoal($goal)
      {
        ...
        $stmt->bindParam(':project_id', $goal->project_id);
      ...
      function createEvent($event)
      {
        ...
        $stmt->bindParam(':project_id', $event->project_id);
        return $stmt->execute();
      }
      ...
      function updateTask($task)
      {
        ...
        $stmt->bindParam(':name', $task->name);
        $stmt->bindParam(':description', $task->description);
        $stmt->bindValue(':project_id', (int)$task->project_id, PDO::PARAM_INT);
      ...
      function updateGoal($goal)
      {
        ...
        $stmt->bindParam(':name', $goal->name);
        $stmt->bindParam(':description', $goal->description);
        $stmt->bindValue(':project_id', (int)$goal->project_id, PDO::PARAM_INT);
        $stmt->bindParam(':end_datetime', $goal->end_datetime);        
      ...
      function updateEvent($event)
      {
        ...
        $stmt->bindParam(':start_datetime', $event->start_datetime);
        $stmt->bindParam(':end_datetime', $event->end_datetime);
        $stmt->bindValue(':project_id', (int)$event->project_id, PDO::PARAM_INT);        
