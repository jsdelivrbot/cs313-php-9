<?php
   # TODO: Default is to display ALL goals.
   # Optionally, you can send in as a parameter the goal ID and show that one goal
?>
<?php
    ...
    <div class="prj-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="prj-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="prj-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" style="color:white;opacity:1;" href="goals.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">check</i>Goals</a>
          ...
          <div class="prj-graphs mdl-shadow--2dp mdl-color--white mdl-cell mdl-cell--12-col mdl-grid">
            ...
            <div class="square-card mdl-card mdl-shadow--2dp mdl-cell mdl-cell--12-col">
              <div class="mdl-card__title mdl-card--expand">
                <h2 class="mdl-card__title-text">Set a Goal</h2>
                <div class="mdl-layout-spacer"></div>
                <i class="material-icons">check</i>                
              </div>
              <div class="mdl-card__supporting-text">
                Create a goal to set you on track for success and to finish your project on time.
              </div>
                ...
                <ul class="demo-list-three mdl-list">
                  ...
                  <li class="mdl-list__item mdl-list__item--three-line">
                     ...
                     <span class="mdl-list__item-secondary-content">
                        <a class="mdl-list__item-secondary-action" href="goals.php?id=<?php echo $goal->id ?>"><i class="material-icons">edit</i></a>
                     </span>
                  </li>
                     <?php } ?>
               </ul>
